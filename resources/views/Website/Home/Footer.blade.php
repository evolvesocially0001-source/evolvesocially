            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="tp-footer-widget tp-footer-col-3 pb-40 mb-30 tp_fade_anim" data-delay=".7">
                    ...
                    <div class="tp-footer-widget-info">
                        <a href="mailto:info@evolvesocially.com">info@evolvesocially.com</a>
                        <a href="tel:+91 7011940533">+91 7011940533</a>
                    </div>
                    <div class="tp-footer-widget-info">
                        <a href="https://www.google.com/maps/" target="_blank">180-C 2nd floor Jeewan
                            Nagar, Maharanibagh, Near tikona park <br> unlight Colony,, Delhi, Delhi
                            110014, Delhi, 110014</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="tp-copyright-content text-center text-md-start">
                    <h2 class="tp-copyright-big-text tp_fade_anim p-relative" style="margin-right: 5px" data-delay=".5"
                        data-fade-from="bottom" data-ease="bounce" data-on-scroll="3">
                        EvolveSocially
                        <img class="tp-copyright-img d-none d-md-block"
                            src="{{ asset('Website/assets/img/home-01/footer/footer-shape-1.png') }}" alt="">
                    </h2>
                </div>
            </div>
        </div>
...
<script src="{{ asset('Website/assets/js/three.js') }}"></script>
<script src="{{ asset('Website/assets/js/slick.js') }}"></script>
<script src="{{ asset('Website/assets/js/scroll-magic.js') }}"></script>
<script src="{{ asset('Website/assets/js/hover-effect.umd.js') }}"></script>
<script src="{{ asset('Website/assets/js/magnific-popup.js') }}"></script>
<script src="{{ asset('Website/assets/js/parallax-slider.js') }}"></script>
...
<script src="{{ asset('Website/assets/js/Observer.min.js') }}"></script>
<script src="{{ asset('Website/assets/js/splitting.min.js') }}"></script>
<script src="{{ asset('Website/assets/js/webgl.js') }}"></script>
<script src="{{ asset('Website/assets/js/parallax-scroll.js') }}"></script>
<script src="{{ asset('Website/assets/js/atropos.js') }}"></script>
<script src="{{ asset('Website/assets/js/slider-active.js') }}"></script>
<script src="{{ asset('Website/assets/js/main.js') }}"></script>
<script src="{{ asset('Website/assets/js/tp-cursor.js') }}"></script>
<script src="{{ asset('Website/assets/js/portfolio-slider-1.js') }}"></script>

<!-- Module scripts -->
<script type="module" src="{{ asset('Website/assets/js/distortion-img.js') }}"></script>
<script type="module" src="{{ asset('Website/assets/js/skew-slider/index.js') }}"></script>
<script type="module" src="{{ asset('Website/assets/js/img-revel/index.js') }}"></script>
